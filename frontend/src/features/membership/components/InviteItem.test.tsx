...
describe('InviteItem', () => {
  it('mostra il nome del workspace', () => {
    render(<InviteItem invite={invite} isPending={false} onAccept={vi.fn()} onReject={vi.fn()} />)
  ...
  it('chiama onAccept con l\'id quando si clicca Accetta', () => {
    ...
    render(<InviteItem invite={invite} isPending={false} onAccept={onAccept} onReject={vi.fn()} />)
  ...
  it('chiama onReject con l\'id quando si clicca Rifiuta', () => {
    ...
    render(<InviteItem invite={invite} isPending={false} onAccept={vi.fn()} onReject={onReject} />)
  ...
  it('disabilita i pulsanti quando isPending è true', () => {
    render(<InviteItem invite={invite} isPending={true} onAccept={vi.fn()} onReject={vi.fn()} />)
