...
describe('BranchSelector', () => {
  it('dovrebbe mostrare lo skeleton durante il caricamento', () => {
    const { container } = render(
      <BranchSelector branches={[]} isLoading selectedBranch="" onChange={vi.fn()} />,
    )
  ...
  it('non dovrebbe mostrare la select durante il caricamento', () => {
    render(
      <BranchSelector branches={branches} isLoading selectedBranch="main" onChange={vi.fn()} />,
    )
  ...
  it('dovrebbe renderizzare le branch come opzioni', () => {
    render(
      <BranchSelector branches={branches} isLoading={false} selectedBranch="main" onChange={vi.fn()} />,
    )
  ...
  it('dovrebbe avere il valore selezionato corretto', () => {
    render(
      <BranchSelector branches={branches} isLoading={false} selectedBranch="develop" onChange={vi.fn()} />,
    )
  ...
  it('dovrebbe chiamare onChange con il valore selezionato', () => {
    ...
    render(
      <BranchSelector branches={branches} isLoading={false} selectedBranch="main" onChange={onChange} />,
    )
