  ...
  return (
    <section className="flex flex-col gap-4 rounded-2xl border border-[var(--chip-line)] bg-[var(--chip-bg)] p-5">
      ...
      <div>
        ...
        <div className="prose prose-sm dark:prose-invert max-w-none text-xs text-[var(--sea-ink)] opacity-80 [&_h1]:text-sm [&_h2]:text-sm [&_h3]:text-xs [&_table]:w-full [&_table]:border-collapse [&_td]:border [&_td]:border-[var(--chip-line)] [&_td]:px-2 [&_td]:py-1 [&_th]:border [&_th]:border-[var(--chip-line)] [&_th]:px-2 [&_th]:py-1">
