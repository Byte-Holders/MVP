      ...
      <footer className="mt-auto border-t border-[var(--h-line)] bg-[var(--h-bg)]">
        <div className="flex flex-col sm:flex-row items-center justify-between min-h-[52px] px-4 py-4 gap-4">
          ...
          <div
              ...
              style={{ color: 'var(--h-text-muted)', fontSize: '13px', fontWeight: 500 }}
          >
            ...
            <span className="hidden sm:inline">Realizzato dal gruppo Byte-Holders</span>
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <a
                ...
                onMouseEnter={(e) => (e.currentTarget.style.background = 'var(--h-btn-hover)')}
                onMouseLeave={(e) => (e.currentTarget.style.background = 'var(--h-btn-bg)')}
            >
