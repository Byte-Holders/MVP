...
describe('Workspace Integration Tests', () => {
  ...
  beforeAll(async () => {
    ...
    service = moduleFixture.get<WorkspaceRepositoryService>(
      WorkspaceRepositoryServiceToken,
    );
  ...
  describe('Gestione Repository nel Workspace', () => {
    it('dovrebbe aggiungere una repository a un workspace esistente nel database', async () => {
      ...
      const workspaceAggiornato = await workspaceModel
        .findById(workspaceIniziale._id)
        .exec();
      ...
      const repositories = await service.getRepositories(
        workspaceIniziale._id.toString(),
      );
  ...
  it('dovrebbe rimuovere una repository da un workspace esistente', async () => {
    ...
    await service.addRepository(
      workspaceId,
      'https://github.com/test/repo-da-rimuovere',
    );
