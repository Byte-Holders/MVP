...
export interface IMembershipRepository {
  addInvite(createMembershipEntityParams: CreateMembershipEntityParams): Promise<void>;
  ...
  findPendingInvite(recipientId: string, workspaceId: string): Promise<MembershipEntity | null>;
