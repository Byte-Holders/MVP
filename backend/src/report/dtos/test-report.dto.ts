...
export class FailedTestDto {
  @ApiProperty({
    description: 'Nome del test fallito',
  ...
  @ApiProperty({
    description: 'Percorso del file contenente il test',
  ...
  @ApiProperty({
    ...
    example:
      'Expected status 401 but received 500: Cannot read properties of undefined',
  })
  @IsString()
  @IsNotEmpty()
