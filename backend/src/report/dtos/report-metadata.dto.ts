...
export class ReportTargetDto {
  ...
  @ApiPropertyOptional({
    description: 'ID interno del repository',
...
export class ReportMetadataDto {
  @ApiProperty({
    description: 'Timestamp di avvio della scansione (ISO 8601)',
  ...
  @ApiProperty({
    description: 'Timestamp di fine della scansione (ISO 8601)',
    example: '2025-04-17T10:04:32.000Z',
  })
  @IsDateString()
  endScanTime!: string;
