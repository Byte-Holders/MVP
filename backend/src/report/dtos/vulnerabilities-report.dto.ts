...
export class CodeVulnerabilityDto {
  @ApiProperty({
    description: 'Identificatore univoco della vulnerabilità',
    example: 'VULN-2024-0042',
  })
  @IsString()
  @IsNotEmpty()
  id!: string;
  ...
  @ApiProperty({
    ...
    example:
      'SQL query costruita con concatenazione diretta di input utente, esposta a SQL Injection.',
  })
  @IsString()
  description!: string;
  ...
  @ApiProperty({
    ...
    example:
      'Utilizzare query parametrizzate o un ORM per evitare la concatenazione diretta di input.',
  })
  @IsString()
  remediation!: string;
  ...
  @ApiProperty({
    description: 'Impatto potenziale della vulnerabilità',
    example: 'Accesso non autorizzato al database e furto di dati sensibili.',
  })
  @IsString()
  impact!: string;

  @ApiProperty({
    description: 'Categoria della vulnerabilità',
    example: 'Injection',
  })
  @IsString()
  category!: string;
  ...
  @ApiPropertyOptional({
    description: 'Identificatore CWE associato',
    example: 'CWE-89',
  })
  @IsOptional()
  @IsString()
